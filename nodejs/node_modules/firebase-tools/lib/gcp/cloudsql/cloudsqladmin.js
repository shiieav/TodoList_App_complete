...
async function updateInstanceForDataConnect(instance, enableGoogleMlIntegration) {
    ...
    const op = await client.patch(`projects/${instance.project}/instances/${instance.name}`, {
        settings: {
            ipConfiguration: {
                enablePrivatePathForGoogleCloudServices: !!((_b = (_a = instance === null || instance === void 0 ? void 0 : instance.settings) === null || _a === void 0 ? void 0 : _a.ipConfiguration) === null || _b === void 0 ? void 0 : _b.privateNetwork),
            },
